import { DownEvents, Line, LineRecord, MoveEvents, PanelConfig, UpEvents } from './model';
...
export class WritingPanel {
    constructor(canvas, options) {
        ...
        this._resetCanvas = () => {
            ...
            if (this._initialized && this._panelConfig.scale === window.devicePixelRatio)
                return;
         ...
         */
        this.getImgBlobOrFile = (type, fileName) => {
         ...
         */
        this._lineRewrite = (clearPanelBgcFlag = true, resetPanelBgcFlag = true) => {
         ...
         */
        this._setLineStyleOnWriting = (lineItem, readyWriteFlag = false) => {
         ...
         */
        this.setPanelCursorStyle = (cursorStyle = null) => {
         ...
         */
        this._removeAllEvtListeners = (rmOnResizeEventListener = false) => {
